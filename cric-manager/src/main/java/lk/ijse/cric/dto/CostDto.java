...
public class CostDto {
    ...
    public CostDto(String costId, String costMId, double ground_fee, double umpire_fee, double equipment_fee, double meal_and_other, double total) {
        this.CostId = costId;
    ...
    public CostDto(String costId, double ground_fee, double umpire_fee, double equipment_fee, double meal_and_other, String matchId) {
        this.CostId = costId;
        this.ground_fee = ground_fee;
        this.umpire_fee = umpire_fee;
        this.equipment_fee = equipment_fee;
        this.meal_and_other = meal_and_other;
        this.CostMId = matchId;
    }
